...
const Footer = () => {
    return (
        <div className='pt-16 pb-16 bg-gray-200 dark:bg-gray-900'>
            <div className='w-[90%] mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-10 items-center'>
                ...
                <div className='xl:col-span-2'>
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <h1 className='text-1xl hidden sm:block md:text-2xl text-cyan-800 dark:text-white font-bold'>
                            DevHire
                        </h1>
                    </div>
                    <p className='mt-4 text-sm text-gray-600 dark:text-gray-400'>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Architecto minima quia doloribus sunt ab dicta aliquam nostrum culpa debitis. Enim.
                    </p>
                    {/* Call */}
                    <div className='mt-5'>
                ...
                {/* 3rd part */}
                  <div className='space-y-6'>
                    ...
                    <p className='footer__link'>Browse Candidates</p>
                     <p className='footer__link'>Employers Dashboards</p>
                      <p className='footer__link'>Candidate Dashboard</p>
            ...
            <div className='pt-6 mt-10 border-t w-[90%] mx-auto border-gray-300 dark:border-gray-800'>
                <p className='text-gray-500'>© 2023 Webdevwarriors. All rights reserved.</p>
            </div>
        </div>
    )
}
