    ...
    return (
        <div className='w-full max-w-4xl mx-auto mt-8'>
            <div className='flex flex-col md:flex-row bg-white dark:bg-gray-900 shadow-md rounded-lg overflow-hidden'>
                ...
                <div className='flex items-center border-b md:border-b-0 border-gray-200 dark:border-gray-700 px-4 sm:py-6 w-full md:w-1/2'>
                ...
                {/* find jobs button */}
                <button className='bg-blue-600 text-white ox-8 sm:py-6 py-3 cursor-pointer 
                text-sm md:text-base w-full md:w-auto min-w-35 whitespace-nowrap hover:bg-blue-700 transition'>
                    Find Jobs
                    </button>
            </div>
        </div>
